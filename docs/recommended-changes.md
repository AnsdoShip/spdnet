...
To simply disable news entirely, comment out the line `add(btnRanking);` in [TitleScene.java](/core/src/main/java/com/shatteredpixel/shatteredpixeldungeon/scenes/TitleScene.java).
